...
//+kubebuilder:rbac:groups=opster.opensearch.opster.io,resources=opensearchusers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=opster.opensearch.opster.io,resources=opensearchusers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=opster.opensearch.opster.io,resources=opensearchusers/finalizers,verbs=update
