...
//+kubebuilder:rbac:groups=opster.opensearch.opster.io,resources=opensearchroles,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=opster.opensearch.opster.io,resources=opensearchroles/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=opster.opensearch.opster.io,resources=opensearchroles/finalizers,verbs=update
