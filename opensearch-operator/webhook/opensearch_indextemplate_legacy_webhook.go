...
// OpenSearchIndexTemplateLegacyValidator validates old API group resources (opensearch.opster.io/v1)
// It denies all user updates to support revert functionality - only the operator can update old CRs
type OpenSearchIndexTemplateLegacyValidator struct {
	Client  client.Client
	decoder admission.Decoder
}

func (v *OpenSearchIndexTemplateLegacyValidator) SetupWithManager(mgr ctrl.Manager) error {
...
func (v *OpenSearchIndexTemplateLegacyValidator) ValidateUpdate(ctx context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	...
	if isStatusOnlyUpdate(oldIndexTemplate.Spec, newIndexTemplate.Spec) {
		return nil, nil
	}
...
func (v *OpenSearchIndexTemplateLegacyValidator) ValidateDelete(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	return nil, nil
}
