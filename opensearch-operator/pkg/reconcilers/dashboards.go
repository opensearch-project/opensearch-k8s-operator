...
func (r *DashboardsReconciler) handleTls() ([]corev1.Volume, []corev1.VolumeMount, error) {
	...
	if tlsConfig.Generate {
		...
		r.recorder.Event(r.instance, "Normal", "Security", "Starting to generating certificates for Dashboard Cluster")
		...
		r.recorder.Event(r.instance, "Normal", "Security", "Notice - using externally provided certificates for Dashboard Cluster")
