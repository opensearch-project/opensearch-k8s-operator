		...
		Spec: batchv1.JobSpec{
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					...
					ImagePullSecrets: image.ImagePullSecrets,
					Tolerations:      instance.Spec.Security.JobConfig.Tolerations,
					NodeSelector:     instance.Spec.Security.JobConfig.NodeSelector,
					Affinity:         instance.Spec.Security.JobConfig.Affinity,
				},
			},
		},
	}
