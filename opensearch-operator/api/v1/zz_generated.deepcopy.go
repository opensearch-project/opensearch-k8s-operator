...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MonitoringStuck) DeepCopyInto(out *MonitoringStuck) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MonitoringStuck.
func (in *MonitoringStuck) DeepCopy() *MonitoringStuck {
	if in == nil {
		return nil
	}
	out := new(MonitoringStuck)
