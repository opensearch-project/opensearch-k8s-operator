...
func (in *ClusterStatus) DeepCopyInto(out *ClusterStatus) {
	*out = *in
	...
	if in.Scaler != nil {
		...
		*out = make(map[string]*ScaleStatus, len(*in))
		for key, val := range *in {
			var outVal *ScaleStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
...
func (in *Item) DeepCopyInto(out *Item) {
	*out = *in
	in.QueryOptions.DeepCopyInto(&out.QueryOptions)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScaleConf) DeepCopyInto(out *ScaleConf) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScaleConf.
func (in *ScaleConf) DeepCopy() *ScaleConf {
	if in == nil {
		return nil
	}
	out := new(ScaleConf)
