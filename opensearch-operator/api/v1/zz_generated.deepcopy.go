...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OsNode) DeepCopyInto(out *OsNode) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OsNode.
func (in *OsNode) DeepCopy() *OsNode {
	if in == nil {
		return nil
	}
	out := new(OsNode)
...
func (in *OsSpec) DeepCopyInto(out *OsSpec) {
	*out = *in
	...
	if in.OsNodes != nil {
		in, out := &in.OsNodes, &out.OsNodes
		*out = make([]OsNode, len(*in))
		copy(*out, *in)
	}
}
