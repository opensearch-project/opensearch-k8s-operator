...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HelperConfig) DeepCopyInto(out *HelperConfig) {
	*out = *in
	if in.Tolerations != nil {
		in, out := &in.Tolerations, &out.Tolerations
		*out = make([]corev1.Toleration, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HelperConfig.
func (in *HelperConfig) DeepCopy() *HelperConfig {
	if in == nil {
		return nil
	}
	out := new(HelperConfig)
	in.DeepCopyInto(out)
	return out
}
