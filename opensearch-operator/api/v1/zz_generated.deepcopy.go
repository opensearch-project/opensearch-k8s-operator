...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserPasswordSpec) DeepCopyInto(out *UserPasswordSpec) {
	*out = *in
	in.SecretKeySelector.DeepCopyInto(&out.SecretKeySelector)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserPasswordSpec.
func (in *UserPasswordSpec) DeepCopy() *UserPasswordSpec {
	if in == nil {
		return nil
	}
	out := new(UserPasswordSpec)
	in.DeepCopyInto(out)
	return out
}
