...
Opensearch cluster can be composed by one or more Nodepools, each represents a logical group or unified roles. Each nodepool can have its own resources and will have autonomic statefulset and service  
```yaml
spec:
    nodePools:
      - component: masters
